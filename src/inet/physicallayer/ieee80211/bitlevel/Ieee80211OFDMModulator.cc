...
const double Ieee80211OFDMModulator::polarityVector[] = {
...
{
    ofdmSymbol->pushAPSKSymbol(new APSKSymbol(polarityVector[symbolID] * std::complex<double>(1, 0)), 5);
    ofdmSymbol->pushAPSKSymbol(new APSKSymbol(polarityVector[symbolID] * std::complex<double>(1, 0)), 19);
    ofdmSymbol->pushAPSKSymbol(new APSKSymbol(polarityVector[symbolID] * std::complex<double>(1, 0)), 33);
    ofdmSymbol->pushAPSKSymbol(new APSKSymbol(polarityVector[symbolID] * std::complex<double>(-1, 0)), 47);
}
